...
def load_prediction_model():
    # Update this path to the correct relative path in your repo
    model_path = os.path.join("5. Project Executable Files", "Flask", "models", "my_model.h5")
    ...
    if uploaded_file is not None:
        ...
        if st.button("🔍 Analyze Nutrients"):
            if model is not None:
                ...
                st.error("Model file not found. Ensure 'my_model.h5' is at '5. Project Executable Files/Flask/models/my_model.h5'")
